...
public class ThiSinh {
    ...
    public String toString(){
        return "ThiSinh [maSinhVien = " + maThiSinh + ", tenThiSinh = " + tenThiSinh + ", queQuan = "
                + queQuan + ", ngaySinh = " + ngaySinh + ", gioiTinh = " + gioiTinh + ", diemMon1 = "
                + diemMon1 + ", diemMon2 = " + diemMon2 + ", diemMon3 = " + diemMon3 + "]";
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Float.floatToIntBits(diemMon1) == Float.floatToIntBits(other.diemMon1)
                ...
                && maThiSinh == other.maThiSinh && Objects.equals(ngaySinh, other.ngaySinh) &&  Objects.equals(tenThiSinh, other.tenThiSinh)
                && Objects.equals(queQuan, other.queQuan) && Objects.equals(gioiTinh, other.gioiTinh);
